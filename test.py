...
def write_csv(path, new_data):
    path_log = os.path.join(os.getcwd(), "log.txt")
    new_head = new_data[0]
...
if __name__ == '__main__':
    ...
    # Path of files
    path_revenue = r"D:\BI_Assignment/netflix_titles.csv"
    path_quantity = r"D:\BI_Assignment/tv_shows.csv"
    path_new = r"D:\BI_Assignment/tv_news2.csv"
    bc = Bcolors()

    while True:
        print(Fore.RED)
        print(f"{Fore.RED}{Back.GREEN}{Style.BRIGHT}----------------------------------------------------------------FILE CSV HANDING PROGRAM----------------------------------------------------------------")
        print(f"{Fore.RED}{Back.BLUE}{Style.DIM}----------------------------------------------------------------The functions of the program----------------------------------------------------------------")
        print(f"{Fore.YELLOW}{Style.DIM}Enter (1) : Display data".format ())
        print(f"{Fore.YELLOW}{Style.DIM}Enter (2) : Merge data".format ())
        print(f"{Fore.YELLOW}{Style.DIM}Enter (3) : Display merged data".format ())
        print(f"{Fore.YELLOW}{Style.DIM}Enter (4) : Clean data".format ())
        print(f"{Fore.YELLOW}{Style.DIM}Enter (5) : Exit".format ())
        print("-" * 64)
        ...
        if choice == 1:
            while True:
                ...
                print("+ Choice: "
                      "\n\t\t1. Display: " + bc.OKCYAN + " Products Category." + bc.ENDC +
                      "\n\t\t2. Display: " + bc.OKCYAN + " Revenue." + bc.ENDC +

...
def write_csv(path, new_data):
    ...
    new_head = new_data[0]
    # Write new data to path_log
    with open(path_log, mode="w", newline='',errors="ignore",) as new_file:
    ...
    with open(path_log, "w", encoding="UTF-8", newline='',errors="ignore",) as log:
    ...
    f = open(path_log, "r", encoding="UTF-8", newline='',errors="ignore",)
    lines = f.read().split()
...
if __name__ == '__main__':
    ...
    path_new = r"D:\BI_Assignment\tv_news4.csv"
    bc = Bcolors()
